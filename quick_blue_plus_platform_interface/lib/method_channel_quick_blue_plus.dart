...
import 'quick_blue_plus_platform_interface.dart';

class MethodChannelQuickBluePlus extends QuickBluePlusPlatform {
  static const MethodChannel _method = MethodChannel('quick_blue_plus/method');
  static const _eventScanResult = EventChannel('quick_blue_plus/event.scanResult');
  static const _messageConnector = BasicMessageChannel('quick_blue_plus/message.connector', StandardMessageCodec());

  MethodChannelQuickBluePlus() {
  ...
  Stream<dynamic> _scanResultStream = _eventScanResult.receiveBroadcastStream({'name': 'scanResult'});
