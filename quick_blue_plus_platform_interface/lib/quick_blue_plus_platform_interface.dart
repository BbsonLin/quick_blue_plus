library quick_blue_plus_platform_interface;
...
export 'method_channel_quick_blue_plus.dart';
export 'models.dart';
...
abstract class QuickBluePlusPlatform extends PlatformInterface {
  QuickBluePlusPlatform() : super(token: _token);

  static final Object _token = Object();

  static late QuickBluePlusPlatform _instance;

  static QuickBluePlusPlatform get instance => _instance;

  static set instance(QuickBluePlusPlatform instance) {
